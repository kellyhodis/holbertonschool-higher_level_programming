...
```
0-square.py - class that defines a square
1-square.py - class that defines a square based on 0-square.py
...
100-singly_linked_list.py - classes that define a node of a singly
    linked list and a singly linked list
101-square.py - class that defines a square based on 6-square.py
102-square.py - class that defines a square based on 4-square.py
103-magic_class.py - reverse engineering Python class that does the
    same as the bytecode:
```

* bytecode to interpret for `103-magic_class.py`:
